...
const messages = {
  'zh-TW': {
    ...
    used: '目前使用', send: '送出', questionEnded: '本題已結束。', answerClosed: '作答時間已結束。', answerSent: '答案已送出。', pinsLeft: '還可以點 {n} 次', pinsUsed: '已經點滿了，點自己的標記可以取消', answerCorrect: '答對了！', answerWrong: '答錯了，等老師公布正確答案。', timeLeft: '剩餘', submittedAnswer: '已送出答案：', interactiveQuestion: '互動題',
  ...
  en: {
    ...
    used: 'Used', send: 'Send', questionEnded: 'This question has ended.', answerClosed: 'Time is up.', answerSent: 'Answer sent.', pinsLeft: '{n} left', pinsUsed: 'All used — tap one of yours to take it back', answerCorrect: 'Correct!', answerWrong: 'Not quite — wait for the answer.', timeLeft: 'Left', submittedAnswer: 'Answer submitted: ', interactiveQuestion: 'Interactive question',
