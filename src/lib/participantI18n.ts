...
const messages = {
  'zh-TW': {
    ...
    boardYoursOnly: '現在只有你看得到自己貼的，老師開放後全班一起看。', boardRevealed: '全班的討論',
    boardUsed: '你已經貼了', boardOf: '，可貼', boardUnlimited: '則數不限', boardWithdraw: '收回',
    boardWithdrawn: '已收回', boardHidden: '已被老師收起', boardEmpty: '還沒有人貼東西。',
    boardYoursEmpty: '你還沒有貼東西。', boardClosed: '討論板已經結束，不能再貼了。',
    boardFull: '你已經貼滿了。收回一則不會多出額度。', boardReply: '回覆', boardReplyPlaceholder: '回覆這則…',
  ...
  en: {
    ...
    boardYoursOnly: 'Only you can see your cards for now. Your teacher opens the board to the class.', boardRevealed: 'The whole class',
    boardUsed: 'You have posted ', boardOf: ' of ', boardUnlimited: 'no limit', boardWithdraw: 'Take back',
    boardWithdrawn: 'Taken back', boardHidden: 'Removed by your teacher', boardEmpty: 'Nothing on the board yet.',
    boardYoursEmpty: 'You have not posted anything yet.', boardClosed: 'The board is closed.',
    boardFull: 'You have used all your cards. Taking one back does not give you another.', boardReply: 'Reply', boardReplyPlaceholder: 'Reply to this…',
