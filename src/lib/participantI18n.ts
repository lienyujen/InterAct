...
const messages = {
  'zh-TW': {
    ...
    used: '目前使用', send: '送出', questionEnded: '本題已結束。', answerClosed: '作答時間已結束。', answerSent: '答案已送出。', timeLeft: '剩餘', submittedAnswer: '已送出答案：', interactiveQuestion: '互動題',
  ...
  en: {
    ...
    used: 'Used', send: 'Send', questionEnded: 'This question has ended.', answerClosed: 'Time is up.', answerSent: 'Answer sent.', timeLeft: 'Left', submittedAnswer: 'Answer submitted: ', interactiveQuestion: 'Interactive question',
