...
const messages = {
  'zh-TW': {
    ...
    boardEdit: '修改', boardEdited: '已修改', boardSave: '儲存', boardCancel: '取消',
    handRaise: '舉手', handLower: '放下手',
    standingScore: '目前分數', standingPoints: '分', standingRank: '班級排名',
    standingAway: '離開', standingMinutes: '分鐘',
  ...
  en: {
    ...
    boardEdit: 'Edit', boardEdited: 'Edited', boardSave: 'Save', boardCancel: 'Cancel',
    handRaise: 'Raise hand', handLower: 'Lower hand',
    standingScore: 'Your score', standingPoints: 'pts', standingRank: 'Rank',
    standingAway: 'Away', standingMinutes: 'min',
