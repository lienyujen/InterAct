...
const messages = {
  'zh-TW': {
    ...
    used: '目前使用', send: '送出', questionEnded: '本題已結束。', answerClosed: '作答時間已結束。', answerSent: '答案已送出。', dragToOrder: '拖曳項目排出你認為的順序', dragToMatch: '拖曳右邊的答案，對齊左邊的題目', pinsLeft: '還可以點 {n} 次', pinsUsed: '已經點滿了，點自己的標記可以取消', answerCorrect: '答對了！', answerWrong: '答錯了，等老師公布正確答案。', timeLeft: '剩餘', submittedAnswer: '已送出答案：', interactiveQuestion: '互動題',
